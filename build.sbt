...
pomExtra := (
  <url>http://github.com/mpilquist/local-implicits</url>
  <scm>
    <url>git@github.com:mpilquist/local-implicits.git</url>
    <connection>scm:git:git@github.com:mpilquist/local-implicits.git</connection>
  </scm>
  <developers>
    <developer>
      <id>mpilquist</id>
